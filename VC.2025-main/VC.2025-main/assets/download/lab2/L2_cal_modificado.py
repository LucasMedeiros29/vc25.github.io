...
# Prepara um objeto como (0,0,0), (1,0,0), (2,0,0) ....,(7,5,0)
...
# O script original procurava por 'foto_*.png'.
# ===========================================================================
...
for fname in images:
    ...
    # Se os cantos forem encontrados, adicione os pontos do objeto e os pontos da imagem
    if ret == True:
        objpoints.append(objp)
        # Refina as coordenadas dos pixels para os pontos 2D fornecidos.
        ...
        # Redimensiona a imagem para exibição se for muito grande
        h, w = img.shape[:2]
        scale_factor = 800 / w
        ...
        cv2.waitKey(500) # Espera 0.5 segundos
    else:
        print(f"Cantos não encontrados em: {fname}")

cv2.destroyAllWindows()

# Verifica se pontos suficientes foram encontrados para a calibração
...
# ===========================================================================
# MODIFICAÇÃO 4: Corrigir as imagens e salvá-las
# ===========================================================================
print("\nAplicando correção de distorção e salvando imagens corrigidas...")
